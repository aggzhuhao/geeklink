...
<head>
    ...
    <title>绑定新设备 | GeekLink用户中心</title>
		...
		<div class="ui grid">
			...
			<div class="four wide column">
				<div class="verticalMenu">
					<div class="ui vertical pointing menu fluid">
  						<a class="active teal item" href="./toAdd">
			...
			<div class="twelve wide column">
				...
				<div class="ui form fluid vertical segment">
					<form id="form" name="form" action="./addDevice" method="post">
						<div class="two fields">
							<div class="field">
								<label>设备名</label>
								<div class="ui small left labeled icon input">
									<input type="text" placeholder="给您的设备起个名,您容易记住就行，30个字符内……" id="name" name="name" value=""/>
                        ...
                        <div class="two fields">
                            ...
                            <div class="field">
                                <div class="diy field">
                                    <label>标签（tags）</label>
                                        <input type="text" id="device_tags" name="tags">
                                </div>
                            </div>
                        </div>
						<div class="diy field">
							...
							<div class="ui dropdown selection">
								<input type="hidden" name="location" value="南通">
								<div class="default text">南通</div>
								<i class="dropdown icon"></i>
								<div class="menu">
								...
								<div class="column">
									<div class="two fields">
										<div class="field" style="margin-bottom:0;">
											<input type="text" id="device_lng" name="longitude" readonly="readonly">
										</div>
										<div class="field" style="margin-bottom:0;">
											<input type="text" id="device_lat" name="latitude" readonly="readonly">
										</div>
									</div>
								</div>
							</div>
						...
						<div class="two fields">
							<div class="field">
								...
								<div class="writeUrl ui small left labeled icon input">
									<i class="url icon"></i>
									<input type="text" placeholder="如http://www.geeklink.net/devices/5905" id="device_address" name="address" value=""/>
								</div>
							</div>
							<div class="field"></div>
						</div>
						...
						<div class="two fields">
							<div class="field">
								...
								<div class="writeUrl ui small left labeled icon input">
									<i class="url icon"></i>
									<input type="text" placeholder="如http://www.geeklink.net/devices/5905" id="api_address" name="apiAddress" value=""/>
								</div>
							</div>
							<div class="field"></div>
						</div>
