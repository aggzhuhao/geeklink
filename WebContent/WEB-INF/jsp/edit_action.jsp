	...
	<!--the content-->
		<div class="ui grid">
            ...
            <div class="twelve wide column">
				...
				<form id="frm_register" class="ui form fluid vertical segment" action="./updateAction" name="form" method="post">
                    <input type="hidden" name="actionId" value="${deviceation.actionId }">
                    <div class="two fields">
                    	<div class="field">
                            <label>动作名</label>
                            <div class="ui small left icon input">
                                <i class="terminal icon"></i>
                                <input type="text" id="name" name="name" value="${deviceation.name }">
                            </div>
                        </div>
                    </div>
                    <div class="field">
                    ...
                    <div class="two fields">
                        <div class="field">
                            ...
                            <div class="ui small left icon input">
                                <i class="terminal icon"></i>
                                <input type="text" id="typeValue" name="typeValue" value="${deviceation.typeValue }" placeholder="请输入相应的邮箱、网址、微博号或手机号">
                            </div>
                        </div>
                    </div>
