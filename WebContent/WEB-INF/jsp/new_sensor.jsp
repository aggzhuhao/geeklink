...
<head>
    ...
    <title>添加传感器 | GeekLink用户中心</title>
		...
		<div class="ui grid">
			...
			<div class="twelve wide column">
				...
				<div class="ui form fluid vertical segment">
					<form id="sensorForm" name="form" action="saveNewSensor" method="post">
						<div class="two fields">
							<div class="field">
								<label>传感器名</label>
								<div class="ui small left labeled icon input">
									<input type="text" placeholder="给您的传感器起个容易记住的名字……" id="device_title" name="name" value=""/>
                        ...
                        <div class="field">
							...
							<div class="ui dropdown selection">
      							...
      							<div class="menu" name="sensor_type" id="sensor_type">
        							<div name="sensorType" class="item active" data-value="1">数值型</div>
        							<div name="sensorType" class="item" data-value="2">开关型</div>
                                    <div name="sensorType" class="item" data-value="3">GPS型</div>
                                    <div name="sensorType" class="item" data-value="4">微博抓取型</div>
      							</div>
    						</div>
						</div>
                        <div class="two fields">
                        	<div class="field">
                            	<div class="field">
                                    <label>标签（tags）</label>
                                        <input type="text" id="sensor_tags" name="tag"/>
                                </div>
                            </div>
                        </div>
						<div class="two fields">
							<div class="field">
								<div class="field">
									<label>描述</label>
									<textarea name="description" placeholder="不超过30个字符……"></textarea>
								</div>
							</div>
						</div>
						...
						<div class="two fields">
							<div class="field">
								...
								<div class="writeUrl ui small left labeled icon input">
									<i class="url icon"></i>
									<input type="text" placeholder="如 http://api.geeklink.net/v1.0/device/5675/sensor/10385" id="device_address" name="address" value=""/>
								</div>
							</div>
							<div class="field"></div>
						</div>
						...
						<div class="two fields">
							<div class="field">
								...
								<div class="writeUrl ui small left labeled icon input">
									<i class="url icon"></i>
									<input type="text" placeholder="如http://api.geeklink.net/v1.0/device/5675/sensor/10385/" id="api_address" name="apiAddress" value=""/>
								</div>
							</div>
							<div class="field"></div>
						</div>

						<input id="insertSensor" class="ui small blue submit button" type="button" value="保存">
